...
class Cards {
  ...
  static const List<CardDefinition> defaultChance = [
    CardDefinition(id: 'ch_00', label: 'Advance to Go. Collect \u00a3200.',
        effect: {'type': 'move_to', 'square': 0},),
    CardDefinition(id: 'ch_01', label: 'Advance to Rosemount. If you pass Go, collect \u00a3200.',
        effect: {'type': 'move_to', 'square': 24},),
    CardDefinition(id: 'ch_02', label: 'Advance to Stonehaven.',
    ...
    CardDefinition(id: 'ch_12', label: 'Take a trip to Aberdeen Station. If you pass Go, collect \u00a3200.',
        effect: {'type': 'move_to', 'square': 5},),
    CardDefinition(id: 'ch_13', label: 'Take a walk in Milltimber. If you pass Go, collect \u00a3200.',
